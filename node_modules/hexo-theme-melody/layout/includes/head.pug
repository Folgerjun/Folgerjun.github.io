...
if (theme.google_adsense && theme.google_adsense.enable)
  script(async src=theme.google_adsense.js crossorigin="anonymous")
  script.
...
if theme.footer_custom_text==='hitokoto'
  script(src="https://v1.hitokoto.cn/?encode=js&charset=utf-8&select=.footer_custom_text" defer)
